...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/szg850102/bt7.7/refs/heads/main/main/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/szg850102/bt7.7/refs/heads/main/main/install/update6.sh|bash
	fi
